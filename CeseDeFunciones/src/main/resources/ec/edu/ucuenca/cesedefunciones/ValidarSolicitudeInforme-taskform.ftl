...
<div id="container">
	<div id="header">
		User Task Form: Cese de Funciones.ValidarSolicitudeInforme
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">informeLegal</label>
                            		<div class="div_checkbox">
                              		${informeLegal}
                            		</div>
                            		...
                            		<label for="name">archivoInformeLegal</label>
                            		<div class="div_checkbox">
                              		${archivoInformeLegal}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">aprobado</label>
                            		<div class="div_texbox">
                              		<input name="aprobado" type="text" class="textbox" id="aprobado" value="${aprobado}" />
                            		</div>
              	
                            		<label for="name">regresarA</label>
                            		<div class="div_texbox">
                              		<input name="regresarA" type="text" class="textbox" id="regresarA" value="${regresarA}" />
                            		</div>
