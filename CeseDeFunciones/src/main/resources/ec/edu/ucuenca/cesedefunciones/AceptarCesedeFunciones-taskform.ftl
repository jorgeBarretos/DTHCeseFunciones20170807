...
<div id="container">
	<div id="header">
		User Task Form: Cese de Funciones.AceptarCesedeFunciones
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">informeDth</label>
                            		<div class="div_checkbox">
                              		${informeDth}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="aceptado" type="text" class="textbox" id="aceptado" value="${aceptado}" />
                            		</div>
