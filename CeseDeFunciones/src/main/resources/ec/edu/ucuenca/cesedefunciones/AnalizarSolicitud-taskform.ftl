<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("informeAnalista");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid informeAnalista");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Cese de Funciones.AnalizarSolicitud
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[admin.bpms]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		${requiereInformeLegal}
                            		</div>
                            		<label for="name">oficioSolicitud</label>
                            		<div class="div_checkbox">
                              		${oficioSolicitud}
                            		</div>
                            		...
                            		<label for="name">informeAnalista</label>
                            		<div class="div_checkbox">
                              		${informeAnalista}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">requiereInformeLegal</label>
                            		<div class="div_texbox">
                              		<input name="requiereInformeLegal" type="text" class="textbox" id="requiereInformeLegal" value="${requiereInformeLegal}" />
                            		</div>
              	
                            		<label for="name">informeAnalista</label>
                            		<div class="div_texbox">
                              		<input name="informeAnalista" type="text" class="textbox" id="informeAnalista" value="${informeAnalista}" />
                            		</div>
