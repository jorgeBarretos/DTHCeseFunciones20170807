...
<div id="container">
	<div id="header">
		User Task Form: Cese de Funciones.RegistrarSolicituddeCesedeFunciones
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">esTitular</label>
                            		<div class="div_texbox">
                              		<input name="esTitular" type="text" class="textbox" id="esTitular" value="${esTitular}" />
                            		</div>
              	
                            		<label for="name">encargadoAnalizar</label>
                            		<div class="div_texbox">
                              		<input name="encargadoAnalizar" type="text" class="textbox" id="encargadoAnalizar" value="${encargadoAnalizar}" />
                            		</div>
              	
                            		<label for="name">solicitante</label>
                            		<div class="div_texbox">
                              		<input name="solicitante" type="text" class="textbox" id="solicitante" value="${solicitante}" />
                            		</div>
