<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("informeLegal");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid informeLegal");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Cese de Funciones.RegistrarInformeLegal
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">informeLegal</label>
                            		<div class="div_texbox">
                              		<input name="informeLegal" type="text" class="textbox" id="informeLegal" value="${informeLegal}" />
                            		</div>
